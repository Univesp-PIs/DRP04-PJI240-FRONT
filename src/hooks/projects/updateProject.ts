import { IUpdateProject } from '@/@types/project'
...
const fetchUpdateProject = async (key: string, params: IUpdateProject) => {
  const { data } = await api.put(`/engsol/update_project/?key=${key}`, {
    ...params,
  })
